 ...
 * Matches ProfileForm exactly:
 *   - "Public Profile" section label
 *   - Avatar circle (size-14) + name + role + "Change photo" link
 *   - Three form fields: Display Name, Email (disabled), Bio (textarea)
 *   - Save button row
 *   - "Change Password" section below with two fields + button
 */
const ProfileLoading = () => (
  <div className="px-5 md:px-8 py-8 max-w-xl animate-pulse">
    {/* Static page heading */}
    <div className="mb-8">
