...
const EditRecipeForm = ({
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
      {/*
       * Two-column grid on xl+ — mirrors RecipeForm layout for consistency.
       * Single column on smaller breakpoints.
       */}
          ...
          <section className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-3 gap-4">
              <Field id="recipe-difficulty" label="Difficulty">
                <Select
                  value={difficulty}
                  onValueChange={markDirty(setDifficulty)}
                >
      ...
      {/* ── Footer: Cancel + Save Changes — full width below both columns ── */}
